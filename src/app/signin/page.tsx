  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6">
      <form onSubmit={onSubmit} className="w-full max-w-sm space-y-4 p-6 rounded-xl border border-white/10 bg-white/5">
        ...
        <button className="w-full rounded bg-foreground text-background py-2 font-semibold">Continue</button>
        <p className="text-sm text-white/70">No account? <Link href="/signup" className="underline">Sign up</Link></p>
      </form>
    </div>
  );
}
